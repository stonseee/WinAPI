...
INT WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInst, LPSTR lpCmdLine, INT nCmdShow)
{
	...
	wClass.hbrBackground = CreatePatternBrush(hBackgroung);
...
{	
	...
	{		
		...
		//PathCombine(dllpath, filepath, ("Fonts\\FondOnlyDLL.dll"));
		...
		DWORD nFonts = 0;
		DWORD lenght = SizeofResource(hInstFont, hFontRes);
		hMyFont = AddFontMemResourceEx(fntData, lenght, nullptr, &nFonts);
	...
	case WM_CONTEXTMENU:
	{
		...
		switch (skin_index)
		{
		case IDR_SQUARE_BLUE:   SetSkinFromDLL(hwnd, "square_blue");		color_index = IDR_CONTEXT_MENU - IDR_SQUARE_BLUE + 1;	break;
